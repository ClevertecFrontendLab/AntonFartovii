...
export const FlowConfirmEmail = () => {
    ...
    useEffect(() => {
        ...
        if (isSuccess) {
            ...
            setValue('');
            dispatch(
                replace(Paths.MAIN + Paths.AUTH + '/' + Paths.CHANGE_PASSWORD, {
                    key: 'result_redirect',
                }),
            );
        }
    ...
    return (
        <Result
            ...
            subTitle={
                <>
                    Мы отправили вам на e-mail <span style={{ fontWeight: '700' }}>{email}</span>
                    <br />
        ...
        >
            <VerificationInput
                ...
                classNames={{
                    ...
                    characterInactive: isError
                        ? 'verification-character-inactive error'
